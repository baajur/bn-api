...
impl fmt::Display for Scopes {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let s = match self {
            ...
            Scopes::CollectionRead => "collection:read",
            Scopes::CollectionWrite => "collection:write",
            ...
            Scopes::ListingWrite => "listing:write",
            Scopes::LootBoxWrite => "loot-box:write",
...
impl FromStr for Scopes {
    ...
    fn from_str(s: &str) -> Result<Self, <Self as FromStr>::Err> {
        let s = match s {
            ...
            "collection:read" => Scopes::CollectionRead,
            "collection:write" => Scopes::CollectionWrite,
            ...
            "listing:write" => Scopes::ListingWrite,
            "loot-box:write" => Scopes::LootBoxWrite,
            ...
            "rarity:write" => Scopes::RarityWrite,
            ...
            "sales-summary-report:read" => Scopes::SalesSummaryReportRead,
